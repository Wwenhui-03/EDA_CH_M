...
def get_only_charactor(line):
    ...
    clean_line = re.sub('(#NUM#)+', ' ', clean_line)
    clean_line = re.sub('(#CHAR#)+', ' ', clean_line)
    clean_line = re.sub('(#NUM##CHAR#)+', '', clean_line)
    clean_line = re.sub('(#CHAR##NUM#)+', '', clean_line)
...
########################################################################
# EDA函数
def eda(sentence, alpha_sr=0.25, alpha_ri=0.25, alpha_rs=0.25, p_rd=0.1, num_aug=9):
