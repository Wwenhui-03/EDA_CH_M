...
class train():
    ...
    def train(self, sent_length,num_class):
        ...
        filename_train = 'result/orig_roc/'+str(self.num_aug) + '/aug' + '_' + get_now_str() +'train'+ '.txt'
        filename_vaild = 'result/orig_roc/'+str(self.num_aug)+ '/aug' + '_' + get_now_str() + 'vaild'+'.txt'
