...
if __name__ == "__main__":
    ...
    for see in range(5):
        for i, dataset_folder in enumerate(dataset_folders):
            ...
            acc, model = run_rnn(train_dir_save, base_dir, train_orig, test_path, category, num_classes, 1, see,output_path)
