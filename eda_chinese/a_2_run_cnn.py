...
def run_cnn(train_dir_save, base_dir ,train_path, test_path, categories,num_class):
...
if __name__ == "__main__":
    for see in range(1):
        ...
        for a_method in a_methods:
            write_path='outputs_f1_cnn/'
            if not os.path.exists(write_path):
                os.makedirs(write_path)
            filename='outputs_f1_cnn/' + a_method+'_'+str(see)+ '_' + get_now_str() + '.txt'
            ...
            for size_folder in size_folders:
                ...
                #test each alpha value
                    ...
                    for alpha in alphas:
                        ...
                        acc = run_cnn(train_dir_save, base_dir, train_path, test_path, category, num_class)
