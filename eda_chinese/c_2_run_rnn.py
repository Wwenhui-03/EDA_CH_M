...
def train(save_dir,val_dir,train_dir, word_to_id, cat_to_id, config, model, save_path,percent_dataset):
...
def run_rnn(train_dir_save, base_dir ,train_path, test_path, categories,num_class,increment):
    ...
    train(save_dir, val_dir, train_dir, word_to_id, cat_to_id, config, model, save_path, increment)
...
if __name__ == "__main__":
    ...
    for see in range(5):
        ...
        seed(see)
        print('seed:', see)
        filename='outputs_f3_rnn/' + get_now_str()
        write_path = 'outputs_f3_rnn/'
        ...
        for size_folder in size_folders:
            ...
            for i in range(len(dataset_folders)):
                ...
                for num_aug in num_aug_list:
                    ...
                    train_dir_save = dataset_folder + '/train_' + str(num_aug)
                    base_dir = dataset_folder
                    acc = run_rnn(train_dir_save, base_dir, train_orig, test_path, category, num_classes, increment=1)
